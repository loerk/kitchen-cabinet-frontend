...
import { VStack, HStack, Image, Input, Icon, Box, Divider, Center, View, ScrollView } from 'native-base';
import { Animated, SafeAreaView, Button, Text, TouchableOpacity } from 'react-native';
...
const Cabinet = () => {
  ...
  return (
      ...
      <ScrollView>
        ...
        <Center>
          <HStack my="5" w="100%" style={{display: 'flex', justifyContent: 'space-around'}}>
            <TouchableOpacity onPress={() => navigation.navigate("Favorites")}>
              <Text>Favorites</Text>
            </TouchableOpacity>

            <Input defaultValue={inputValue} onChangeText={(newText) => setInputValue(newText)} placeholder="Search" variant="filled" width="50%" borderRadius="10" py="1" px="2" InputLeftElement={<Icon ml="2" size="4" color="gray.400" />} />
