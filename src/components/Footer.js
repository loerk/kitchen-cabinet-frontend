...
const Footer = () => {
  ...
  return (
    ...
    <HStack bg="green.600" alignItems="center" safeAreaBottom shadow={6}>
      ...
      <Pressable cursor="pointer" opacity={selected === 1 ? 1 : 0.5} py="2" flex={1} onPress={() => {setSelected(1); navigation.navigate("Recipes");}}>
        <Center>
      ...
      <Pressable cursor="pointer" opacity={selected === 2 ? 1 : 0.6} py="2" flex={1} onPress={() => {setSelected(2); navigation.navigate("Shopping List")}}>
        <Center>
      ...
      <Pressable cursor="pointer" opacity={selected === 3 ? 1 : 0.5} py="2" flex={1} onPress={() => {setSelected(3); navigation.navigate("Profile")}}>
        <Center>
